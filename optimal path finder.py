#ujjwal Tiwari
# Optimal Path Finder
import pygame                # Library to create Interactive GUI
import sys
import math
from tkinter import *         #library to create menu
...
bg = PhotoImage(file = "C:/Users/ujjwa/Downloads/program/VIT2.png")
label1 = Label( window, image = bg)
label1.place(x = 280, y =80)
label = Label(window, text='ENTER Starting Points : x,y (must be between 1,1 and 39,39)',fg='purple')
startBox = Entry(window)
label1 = Label(window, text='ENTER Ending Points : x,y (must be between 1,1 and 39,39)',fg='purple')
endBox = Entry(window)
var = IntVar()
displaymovement = ttk.Checkbutton(window, text='Click for step by step working', onvalue=1, offvalue=0, variable=var )
...
#the output and result of the distance that is being calculated
            Tk().wm_withdraw()
            result = messagebox.showinfo('Program Finished', ('The shortest distance  is : ' + str(temp) + ' blocks\n\n AI PROJECT'))
